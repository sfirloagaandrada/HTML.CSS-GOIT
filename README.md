...
Proiectul a fost construit etapizat, evoluând de la un simplu document text la o pagină web modernă:

HTML5: Structurarea semantică a conținutului (header, section, footer, liste pentru skill-uri).

CSS3: Stilizarea vizuală, utilizarea culorilor, fonturilor (Google Fonts) și a layout-ului (Flexbox/Grid) pentru un design responsive.
